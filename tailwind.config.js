  ...
  theme: {
    ...
    extend: {
      ...
      typography: ({ theme }) => ({
        DEFAULT: {
          css: {
            color: 'var(--quix-text-default)',
            '[class~="lead"]': {
              color: 'var(--quix-text-secondary)',
            },
            a: {
              color: 'var(--quix-primary-500)',
            },
            strong: {
              color: 'var(--quix-text-default)',
            },
            ...
            'ul > li::before': {
              backgroundColor: 'var(--quix-text-hint)',
            },
            hr: {
              borderColor: 'var(--quix-border)',
            },
            blockquote: {
              color: 'var(--quix-text-default)',
              borderLeftColor: 'var(--quix-border)',
            },
            h1: {
              color: 'var(--quix-text-default)',
            },
            ...
            thead: {
              color: 'var(--quix-text-default)',
              borderBottomColor: 'var(--quix-border)',
            },
            'tbody tr': {
              borderBottomColor: 'var(--quix-border)',
            },
