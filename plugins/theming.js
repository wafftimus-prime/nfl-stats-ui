            ...
            const schemeCustomProps = _.map(
                ...
                (colorScheme) => {
                    ...
                    const background = theme(
                        `quix.customProps.background.${colorScheme}`
                    );
                    const foreground = theme(
                        `quix.customProps.foreground.${colorScheme}`
                    );
                        ...
                        _.flatten(
                            _.map(
                                ...
                                (name) => [
                                    [
                                        name,
                                        `rgba(var(--quix-${name}-rgb), <alpha-value>)`,
                                    ],
                                    [
                                        `on-${name}`,
                                        `rgba(var(--quix-on-${name}-rgb), <alpha-value>)`,
                                    ],
                                ]
                            )
                        )
